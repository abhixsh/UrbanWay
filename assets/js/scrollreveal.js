var ScrollReveal = (function () {
    ...
    function p(e) {
        ...
        i.rotate.x && j.push(((d = i.rotate.x), (u = (Math.PI / 180) * d), ((f = z())[5] = f[10] = Math.cos(u)), (f[6] = f[9] = Math.sin(u)), (f[9] *= -1), f)),
            i.rotate.y && j.push(((h = i.rotate.y), (p = (Math.PI / 180) * h), ((m = z())[0] = m[10] = Math.cos(p)), (m[2] = m[8] = Math.sin(p)), (m[2] *= -1), m)),
            i.rotate.z && j.push(((y = i.rotate.z), (v = (Math.PI / 180) * y), ((g = z())[0] = g[5] = Math.cos(v)), (g[1] = g[4] = Math.sin(v)), (g[4] *= -1), g)),
        ...
        if (j.length) {
            ...
            var q = j.reduce(F);
            R.generated = { initial: R.property + ": matrix3d(" + q.join(", ") + ");", final: R.property + ": matrix3d(" + R.computed.matrix.join(", ") + ");" };
        ...
        if (E.generated || R.generated.initial) {
            ...
            var P = i.delay,
                L = i.duration,
                M = i.easing;
            E.generated && A.fragments.push({ delayed: "opacity " + L / 1e3 + "s " + M + " " + P / 1e3 + "s", instant: "opacity " + L / 1e3 + "s " + M + " 0s" }),
                R.generated.initial && A.fragments.push({ delayed: R.property + " " + L / 1e3 + "s " + M + " " + P / 1e3 + "s", instant: R.property + " " + L / 1e3 + "s " + M + " 0s" }),
                A.computed && !A.computed.match(/all 0s|none 0s/) && A.fragments.unshift({ delayed: A.computed, instant: A.computed });
    ...
    function l(e, t) {
        ...
        if (n) {
            ...
            if (((n.models = { visible: r, revealed: o }), !o.body.length)) {
                ...
                if (a) return j.call(this, n, r.body[0], -1, t), j.call(this, n, r.body[0], 1, t), c.call(this, a, { reveal: !0, pristine: t });
            }
            if (!n.blocked.head && i === [].concat(o.head).pop() && i >= [].concat(r.body).shift()) return j.call(this, n, i, -1, t), c.call(this, e, { reveal: !0, pristine: t });
            if (!n.blocked.foot && i === [].concat(o.foot).shift() && i <= [].concat(r.body).pop()) return j.call(this, n, i, 1, t), c.call(this, e, { reveal: !0, pristine: t });
        }
    }
    function E(e) {
        var t = Math.abs(e);
                    ...
                    return (
                        s.contains(t) &&
                            (null ===
                                ...
                                })(s, d, c.store.containers)) && ((o = b()), d.push({ id: o, node: s })),
                            (n.config = r),
                            (n.containerId = o),
                            (n.styles = p(n)),
                            l && ((n.sequence = { id: l.id, index: l.members.length }), l.members.push(n.id)),
                            e.push(n)),
                        e
                    );
                }, []),
    ...
    function R(e, t) {
        for (
            var n = t ? e.node.clientHeight : e.node.offsetHeight, i = t ? e.node.clientWidth : e.node.offsetWidth, r = 0, o = 0, s = e.node;
        ...
        void 0 === e && (e = { type: "init" }),
            ...
            x(function () {
                ...
                f(i.store.containers, function (e) {
                    ...
                    var t = function (e) {
                        var t, n;
                        return (n = e.node === document.documentElement ? ((t = window.pageYOffset), window.pageXOffset) : ((t = e.node.scrollTop), e.node.scrollLeft)), { top: t, left: n };
                    }.call(i, e);
    ...
    function H(e) {
        ...
        return (!(C = t).mobile && g()) || (!C.desktop && !g())
            ? (h.call(this, "This device is disabled.", "desktop: " + C.desktop, "mobile: " + C.mobile), n.failure())
            : (n.success(),
